...
<div class="card">
    ...
    <div class="card-body">
        <!-- Search Form -->
        <form action="{{ route('physician.patients.index') }}" method="GET" class="form-inline mb-3">
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    ...
                    <a href="{{ route('physician.patients.index') }}" class="btn btn-clr"><i class="fas fa-times"></i> Clear</a>
                </div>
            </div>
        </form>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-group">
                                    <a href="{{ route('physician.patients.transactions', $patient->id) }}" class="btn btn-info btn-sm">
                                        <i class="fas fa-eye"></i> {{ __('Transactions') }}
                                    </a>
                                    <a href="{{ route('physician.patients.show', $patient->id) }}" class="btn btn-dts btn-sm">
