...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('physician.consultations.create') }}" class="btn btn-success">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="{{ route('physician.consultations.show', $consultation->id) }}"
                                ...
                                @if($consultation->status === 'pending')
                                    <form action="{{ route('physician.consultations.forward', $consultation->id) }}" method="POST" class="inline-block">
                                        @csrf
                                        <button type="submit"
                                    ...
                                    <a href="{{ route('physician.consultations.edit', $consultation->id) }}"
                                ...
                                <form action="{{ route('physician.consultations.destroy', $consultation->id) }}" method="POST" class="inline-block">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
