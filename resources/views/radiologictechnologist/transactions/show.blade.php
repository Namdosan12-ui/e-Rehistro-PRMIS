...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-container">
            ...
            <div class="form-group6">
                ...
                @if ($transaction->consultation)
                    ...
                    <p class="card-text">Consultation Date: {{ \Carbon\Carbon::parse($transaction->consultation->date)->format('Y-m-d') }}</p>
        ...
        <a href="{{ route('radiologictechnologist.transactions.edit', $transaction->id) }}" class="btn btn-warning">Edit Transaction</a>
        <a href="javascript:window.print()" class="btn btn-primary">Print</a>
        <a href="{{ route('radiologictechnologist.transactions.index') }}" class="btn btn-cancel6">{{ __('Cancel') }}</a>
    </div>
</div>
