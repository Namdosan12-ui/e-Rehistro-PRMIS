...
<div class="card-body">
    <div class="table-container">
        ...
        <form action="{{ route('radiologictechnologist.transactions.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-success4">Create Transaction</button>
                <a href="{{ route('radiologictechnologist.transactions.index') }}" class="btn btn-cancel4">{{ __('Cancel') }}</a>
        </form>
    </div>
