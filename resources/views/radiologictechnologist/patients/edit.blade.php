...
<div class="card-body">
    <div class="table-container">
        <form action="{{ route('radiologictechnologist.patients.update', $patient->id) }}" method="POST">
            @csrf
            @method('PUT')
           ...
           <div class="form-group">
            ...
            <a href="{{ route('radiologictechnologist.patients.index') }}" class="btn btn-cancel">{{ __('Cancel') }}</a>
        </form>
    </div>
</div>
@endsection
