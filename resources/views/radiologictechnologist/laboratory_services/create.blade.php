...
<div class="card">
    ...
    <div class="card-body1">
        ...
        <div class="table-container0">
            ...
            <form action="{{ route('radiologictechnologist.laboratory_services.store') }}" method="POST">
                @csrf
                ...
                <div class="button-group1">
                    ...
                    <a href="{{ route('radiologictechnologist.laboratory_services.index') }}" class="btn btn-cancel5">{{ __('Cancel') }}</a>
                </div>
            </form>
...
<div class="card">
    ...
    <div class="card-body3">
            ...
            <form action="{{ route('radiologictechnologist.categories.store') }}" method="POST">
                @csrf
