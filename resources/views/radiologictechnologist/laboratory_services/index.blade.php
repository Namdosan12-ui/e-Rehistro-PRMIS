...
<div class="card">
    ...
    <form action="{{ route('radiologictechnologist.laboratory_services.index') }}" method="GET" class="form-inline mb-3">
        ...
        <div class="input-group">
            ...
            <div class="input-group-append">
                ...
                <a href="{{ route('radiologictechnologist.laboratory_services.index') }}" class="btn btn-clr"><i class="fas fa-times"></i> Clear</a>
            </div>
        </div>
    </form>
                    ...
                    @foreach ($services as $service)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('radiologictechnologist.laboratory_services.show', $service->id) }}" class="btn btn-info btn-sm"><i class="fas fa-eye"></i> View Info</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
