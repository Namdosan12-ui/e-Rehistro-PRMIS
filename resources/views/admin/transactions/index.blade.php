...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('admin.transactions.create') }}" class="btn btn-success">Avail Services</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-group">
                                    ...
                                    <form action="{{ route('admin.transactions.destroy', $transaction->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this transaction?');">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    @if ($transaction->payment_status == 'unpaid')
                                        <form action="{{ route('admin.transactions.markPaid', $transaction->id) }}" method="POST" style="display: inline;">
                                            @csrf
