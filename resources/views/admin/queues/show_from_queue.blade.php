...
<div class="card">
    <div class="relative bg-gradient-to-r from-blue-500 to-white-600 px-8 py-12 overflow-hidden">
        ...
        <div class="relative flex justify-between items-center">
            ...
            <a href="{{ route('admin.queues.index') }}" class="px-6 py-3 bg-blue-400/40 text-blue rounded-xl font-semibold hover:bg-blue-400/50 transition-all duration-200 flex items-center space-x-2">
