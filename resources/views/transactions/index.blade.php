...
<div class="all-container">
    ...
    <a href="{{ route('transactions.create') }}" class="btn btn-primary mb-3">Avail Services</a>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('transactions.show', $transaction->id) }}" class="btn btn-info btn-sm">
                        <i class="fas fa-eye"></i> {{ __('Transactions') }}</a>
...
<script>
    // Timeout function to hide success message after 5 seconds
    setTimeout(function() {
