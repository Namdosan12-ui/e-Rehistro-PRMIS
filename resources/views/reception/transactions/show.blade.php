    ...
    <div class="relative bg-gradient-to-r from-blue-500 to-white-600 px-4 py-8 overflow-hidden">
        ...
        <div class="relative flex justify-between items-center">
            ...
            <div class="flex space-x-4">
                ...
                <a href="{{ route('reception.transactions.edit', $transaction->id) }}" class="px-6 py-3 bg-yellow-400/40 text-yellow-700 rounded-xl font-semibold hover:bg-yellow-400/50 transition-all duration-200 flex items-center space-x-2">
                ...
                <!-- Back Button -->
                <a href="{{ route('reception.transactions.index') }}" class="px-6 py-3 bg-blue-400/40 text-blue rounded-xl font-semibold hover:bg-blue-400/50 transition-all duration-200 flex items-center space-x-2">
