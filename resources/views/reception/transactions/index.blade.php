...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('reception.transactions.create') }}" class="btn btn-success">Avail Services</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-group">
                                    <a href="{{ route('reception.transactions.show', $transaction->id) }}" class="btn btn-info btn-sm">
                                        <i class="fas fa-eye"></i> {{ __('View') }}
                                    </a>

                                    <form action="{{ route('reception.transactions.destroy', $transaction->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this transaction?');">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    @if ($transaction->payment_status == 'unpaid')
                                        <form action="{{ route('reception.transactions.markPaid', $transaction->id) }}" method="POST" style="display: inline;">
                                            @csrf
