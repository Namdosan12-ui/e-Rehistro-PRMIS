    ...
    <div class="card">
        ...
        <div class="flex space-x-4">
            ...
            <div class="flex justify-end space-x-4 mt-4">
                ...
                <!-- Cancel Button -->
                <a href="{{ route('reception.patients.index') }}" class="bg-red-500 text-white px-6 py-3 rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500">
                    {{ __('Cancel') }}
                </a>
            </div>
        </div>
