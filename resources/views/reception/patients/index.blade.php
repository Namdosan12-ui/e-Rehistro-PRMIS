...
<div class="card">
    ...
    <div class="card-body">
        <!-- Search Form -->
        <form action="{{ route('reception.patients.index') }}" method="GET" class="form-inline mb-3">
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    ...
                    <a href="{{ route('reception.patients.index') }}" class="btn btn-clr"><i class="fas fa-times"></i> Clear</a>
                </div>
            </div>
        </form>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-group">
                                    <a href="{{ route('reception.patients.edit', $patient->id) }}" class="btn btn-edit btn-sm">
                                        <i class="fas fa-edit"></i> {{ __('Edit') }}
                                    </a>
                                    <a href="{{ route('reception.patients.transactions', $patient->id) }}" class="btn btn-info btn-sm">
                                        <i class="fas fa-eye"></i> {{ __('Transactions') }}
                                    </a>
                                    <a href="{{ route('reception.patients.show', $patient->id) }}" class="btn btn-dts btn-sm">
                                        <i class="fas fa-eye"></i> {{ __('Details') }}
                                    </a>
                                    <form action="{{ route('reception.patients.destroy', $patient->id) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
