...
<div class="card">
    ...
    <form action="{{ route('reception.laboratory_services.index') }}" method="GET" class="form-inline mb-3">
        ...
        <div class="input-group">
            ...
            <div class="input-group-append">
                ...
                <a href="{{ route('reception.laboratory_services.index') }}" class="btn btn-clr"><i class="fas fa-times"></i> Clear</a>
            </div>
        </div>
    </form>
                    ...
                    @foreach ($services as $service)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('reception.laboratory_services.show', $service->id) }}" class="btn btn-info btn-sm"><i class="fas fa-eye"></i> View Info</a>
                                <a href="{{ route('reception.laboratory_services.edit', $service->id) }}" class="btn btn-edit btn-sm"><i class="fas fa-edit"></i> Edit</a>

                                <form action="{{ route('reception.laboratory_services.destroy', $service->id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
    ...
    <a href="{{ route('reception.laboratory_services.create') }}" class="btn btn-success">{{ __('New Service') }}</a>
</div>
