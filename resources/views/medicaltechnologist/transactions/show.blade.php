...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('medicaltechnologist.transactions.edit', $transaction->id) }}" class="btn btn-warning">Edit Transaction</a>
        <a href="javascript:window.print()" class="btn btn-primary">Print</a>
        <a href="{{ route('medicaltechnologist.transactions.index') }}" class="btn btn-cancel6">{{ __('Cancel') }}</a>
    </div>
</div>
