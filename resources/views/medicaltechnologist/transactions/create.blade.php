...
<div class="card-body">
    <div class="table-container">
        ...
        <form action="{{ route('medicaltechnologist.transactions.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <a href="{{ route('medicaltechnologist.transactions.index') }}" class="btn btn-cancel4">{{ __('Cancel') }}</a>
        </form>
    </div>
