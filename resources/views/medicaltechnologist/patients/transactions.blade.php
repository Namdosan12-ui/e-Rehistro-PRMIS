...
<div class="card">
    ...
    <!-- Search Form -->
    <form action="{{ route('medicaltechnologist.transactions.search', ['patient_id' => $patient->id]) }}" method="GET" class="form-inline mb-3 search-form">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('medicaltechnologist.patients.index') }}" class="btn btn-success">{{ __('Back to Patients List') }}</a>
    </div>
</div>
