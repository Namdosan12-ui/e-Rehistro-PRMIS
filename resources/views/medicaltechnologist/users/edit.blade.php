...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 transition-all duration-300 ease-in-out"
    ...
    <!-- Main Content Area - Adjusted for topbar -->
    <div class="pt-28"> <!-- Increased top padding to account for topbar -->
        <div class="container mx-auto px-4 pb-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div class="relative bg-gradient-to-r from-blue-500 to-white-600 px-8 py-12 overflow-hidden">
                    ...
                    <div class="relative flex justify-between items-center">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <a href="{{ route('medicaltechnologist.users.index') }}"
                ...
                <!-- Form Content -->
                <form id="editUserForm" action="{{ route('medicaltechnologist.users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
