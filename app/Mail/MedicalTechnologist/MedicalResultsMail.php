<?php
namespace App\Mail\MedicalTechnologist;
...
class MedicalResultsMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            tags: ['medical-results', 'medical-technologist', 'patient-' . $this->releasing->transaction->patient_id],
            metadata: [
                'releasing_id' => $this->releasing->id,
                'transaction_id' => $this->releasing->transaction_id,
                'sent_by' => 'medical-technologist'
            ]
        );
    }
    ...
    {
        return new Content(
            view: 'medicaltechnologist.emails.medical-results',
            with: [
