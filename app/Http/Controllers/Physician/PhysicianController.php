...
use App\Mail\Physician\MedicalResultsMail;
...
class PhysicianController extends Controller
{
    public function index()
    {
        ...
        return view('physician.index', compact(
            'patientCount',
...
public function usersIndex()
{
    ...
    return view('physician.users.index', compact('users'));
}
...
{
    $roles = Role::all();
    return view('physician.users.create', compact('roles'));
}
...
public function usersStore(Request $request)
{
    ...
    return redirect()->route('physician.users.index')->with('success', 'User created successfully.');
}
...
public function usersEdit($id)
{
    ...
    $roles = Role::all();
    return view('physician.users.edit', compact('user', 'roles'));
}
...
public function usersUpdate(Request $request, $id)
{
    ...
    return redirect()->route('physician.users.index')->with('success', 'User updated successfully');
}
...
public function usersDestroy(User $user)
{
    ...
    $user->delete();
    return redirect()->route('physician.users.index')->with('success', 'User deleted successfully.');
}
    ...
    public function laboratoryServicesIndex(Request $request)
    {
        ...
        return view('physician.laboratory_services.index', compact('services'));
    }
    ...
    public function laboratoryServicesCreate()
    {
        ...
        return view('physician.laboratory_services.create', compact('categories'));
    }
    ...
    public function laboratoryServicesStore(Request $request)
    {
        ...
        return redirect()->route('physician.laboratory_services.index')
    ...
    public function laboratoryServicesShow($id)
    {
        ...
        return view('physician.laboratory_services.show', compact('laboratoryService'));
    }
    ...
    public function laboratoryServicesEdit( $id)
    {
        ...
        return view('physician.laboratory_services.edit', compact('laboratoryService', 'categories'));
    }
    ...
    public function patientsIndex(Request $request)
    {
        ...
        $patients = $query->get();
        return view('physician.patients.index', compact('patients'));
    }
    ...
    public function patientsCreate()
    {
        ...
        return view('physician.patients.create', compact('vaccineTypes', 'boosterTypes', 'civilStatusOptions', 'patientTypes'));
    }
    ...
    public function patientsStore(Request $request)
    {
        ...
        return redirect()->route('physician.patients.index')->with('success', 'Patient created successfully.');
    }
    ...
    public function patientsShow(Patient $patient)
    {
        ...
        return view('physician.patients.show', compact('patient', 'civilStatusOptions'));
    }
    ...
    $patientTypes = PatientType::all();
        return view('physician.patients.edit', compact('patient', 'vaccineTypes', 'boosterTypes', 'civilStatusOptions', 'patientTypes'));
    }
    ...
    public function patientsUpdate(Request $request, Patient $patient)
    {
      ...
      if ($request->profile_picture) {
        ...
        return redirect()->route('physician.patients.index')->with('success', 'Patient updated successfully.');
    }
    ...
    public function patientsDestroy(Patient $patient)
    {
        ...
        $patient->delete();
        return redirect()->route('physician.patients.index')->with('success', 'Patient has been deleted successfully.');
    }
    public function showPatientTransactions(Patient $patient)
{
    ...
    return view('physician.patients.transactions', compact('patient', 'transactions'));
}
...
public function searchPatientTransactions(Request $request, $patient_id)
{
    ...
    public function queuesIndex()
    {
        $queues = Queue::with(['transaction.patient', 'transaction.services'])
            ...
            ->get();
        return view('physician.queues.index', compact('queues'));
    }
    ...
    public function queuesStartProcess(Queue $queue)
    {
        ...
        if ($queue->status === 'pending') {
            ...
            $queue->save();
            return redirect()->route('physician.queues.index')
...
public function queuesRelease(Queue $queue)
{
   ...
   public function releasingsIndex()
   {
       ...
       return view('physician.releasings.index', compact('releasings'));
   }
   public function releasingsDestroy($id)
   {
       try {
           ...
           return redirect()->route('physician.releasings.index')
   ...
   public function releasingsUpload(Request $request, $id)
   {
       ...
       return redirect()->route('physician.releasings.index')->with('success', 'Result file uploaded successfully.');
   }
   ...
   public function releasingsSendEmail($id)
{
   try {
       ...
       if (!$releasing->transaction->patient->email_address) {
           ...
           $viewLink = route('physician.releasings.view', $releasing->id);
...
private function getErrorMessage(\Exception $e): string
{
   ...
   public function releasingsRelease(Request $request, $id)
   {
    ...
    public function transactionsIndex()
    {
        ...
        return view('physician.transactions.index', compact('transactions'));
    }
    ...
    public function transactionsCreate()
    {
        ...
        return view('physician.transactions.create', compact('patients', 'categories'));
    }
    ...
    public function transactionsStore(Request $request)
    {
        ...
        return redirect()->route('physician.transactions.index')->with('success', 'Transaction created successfully.');
    }
    ...
    public function transactionsShow(Transaction $transaction)
    {
        ...
        return view('physician.transactions.show', compact('transaction'));
    }
    ...
    public function transactionsEdit(Transaction $transaction)
    {
        $categories = Category::all();
        $patients = Patient::all();
        return view('physician.transactions.edit', compact('transaction', 'categories', 'patients'));
    }
    ...
    public function transactionsUpdate(Request $request, Transaction $transaction)
    {
        ...
        return redirect()->route('physician.transactions.index')->with('success', 'Transaction updated successfully.');
    }
    ...
    {
        $transaction->delete();
        return redirect()->route('physician.transactions.index')->with('success', 'Transaction deleted successfully.');
    }
    ...
    public function transactionsMarkPaid(Transaction $transaction)
    {
        ...
        $transaction->save();
        return redirect()->route('physician.transactions.index')->with('success', 'Transaction marked as paid.');
    }
...
public function consultationsIndex()
{
    ...
    return view('physician.consultations.index', compact('consultations'));
}
...
public function consultationsCreate()
{
    ...
    return view('physician.consultations.create', compact('patients'));
}
...
public function consultationsStore(Request $request)
{
    ...
    return redirect()->route('physician.consultations.index')
...
public function consultationsShow($id)
{
    ...
    return view('physician.consultations.show', compact('consultation'));
}
...
public function consultationsEdit($id)
{
    ...
    return view('physician.consultations.edit', compact('consultation', 'patients'));
}
...
public function consultationsDestroy($id)
{
    ...
    return redirect()->route('physician.consultations.index')->with('success', 'Consultation deleted successfully.');
}
public function queuesDisplay()
{
    $queues = Queue::all(); // Adjust this query as needed
    return view('physician.queues.queue_display', compact('queues'));
}
...
public function consultationsForward($id)
{
    ...
    {
        return view('physician.queues.show_from_queue', compact('transaction'));
    }
}
