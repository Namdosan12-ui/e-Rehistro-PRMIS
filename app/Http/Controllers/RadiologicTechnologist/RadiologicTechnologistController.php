...
namespace App\Http\Controllers\RadiologicTechnologist;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Mail;
use App\Mail\RadiologicTechnologist\MedicalResultsMail;
...
class RadiologicTechnologistController extends Controller
{
    public function index()
    {
        ...
        return view('radiologictechnologist.index', compact(
            'patientCount',
...
public function usersIndex()
{
    ...
    return view('radiologictechnologist.users.index', compact('users'));
}

public function usersCreate()
{
    $roles = Role::all();
    return view('radiologictechnologist.users.create', compact('roles'));
}
...
public function usersStore(Request $request)
{
    ...
    return redirect()->route('radiologictechnologist.users.index')->with('success', 'User created successfully.');
}
...
public function usersEdit($id)
{
    ...
    $roles = Role::all();
    return view('radiologictechnologist.users.edit', compact('user', 'roles'));
}
...
public function usersUpdate(Request $request, $id)
{
    ...
    return redirect()->route('radiologictechnologist.users.index')->with('success', 'User updated successfully');
}
...
public function usersDestroy(User $user)
{
    ...
    $user->delete();
    return redirect()->route('radiologictechnologist.users.index')->with('success', 'User deleted successfully.');
}
    ...
    public function laboratoryServicesIndex(Request $request)
    {
        ...
        return view('radiologictechnologist.laboratory_services.index', compact('services'));
    }

    public function laboratoryServicesCreate()
    {
        $categories = Category::all();
        return view('radiologictechnologist.laboratory_services.create', compact('categories'));
    }
    ...
    public function laboratoryServicesStore(Request $request)
    {
        ...
        return redirect()->route('radiologictechnologist.laboratory_services.index')
    ...
    public function laboratoryServicesShow($id)
    {
        ...
        return view('radiologictechnologist.laboratory_services.show', compact('laboratoryService'));
    }
    ...
    public function laboratoryServicesEdit( $id)
    {
        ...
        return view('radiologictechnologist.laboratory_services.edit', compact('laboratoryService', 'categories'));
    }
    ...
    public function patientsIndex(Request $request)
    {
        ...
        $patients = $query->get();
        return view('radiologictechnologist.patients.index', compact('patients'));
    }
    ...
    public function patientsCreate()
    {
        ...
        return view('radiologictechnologist.patients.create', compact('vaccineTypes', 'boosterTypes', 'civilStatusOptions', 'patientTypes'));
    }
    ...
    public function patientsStore(Request $request)
    {
        ...
        return redirect()->route('radiologictechnologist.patients.index')->with('success', 'Patient created successfully.');
    }
    ...
    public function patientsShow(Patient $patient)
    {
        ...
        return view('radiologictechnologist.patients.show', compact('patient', 'civilStatusOptions'));
    }
    ...
    $patientTypes = PatientType::all();
        return view('radiologictechnologist.patients.edit', compact('patient', 'vaccineTypes', 'boosterTypes', 'civilStatusOptions', 'patientTypes'));
    }
    ...
    public function patientsUpdate(Request $request, Patient $patient)
    {
        ...
        return redirect()->route('radiologictechnologist.patients.index')->with('success', 'Patient updated successfully.');
    }
    ...
    public function patientsDestroy(Patient $patient)
    {
        ...
        $patient->delete();
        return redirect()->route('radiologictechnologist.patients.index')->with('success', 'Patient has been deleted successfully.');
    }
    ...
    public function showPatientTransactions(Patient $patient)
    {
        ...
        return view('radiologictechnologist.patients.transactions', compact('patient', 'transactions'));
    }
...
public function searchPatientTransactions(Request $request, $patient_id)
{
    ...
    public function queuesIndex()
    {
        $queues = Queue::with(['transaction.patient', 'transaction.services'])
            ...
            ->get();
        return view('radiologictechnologist.queues.index', compact('queues'));
    }
    ...
    public function queuesStartProcess(Queue $queue)
    {
        ...
        if ($queue->status === 'pending') {
            ...
            $queue->save();
            return redirect()->route('radiologictechnologist.queues.index')
...
public function queuesRelease(Queue $queue)
{
   ...
   public function releasingsIndex()
   {
       ...
       return view('radiologictechnologist.releasings.index', compact('releasings'));
   }
   public function releasingsDestroy($id)
   {
       try {
           ...
           return redirect()->route('radiologictechnologist.releasings.index')
   ...
   public function releasingsUpload(Request $request, $id)
   {
       ...
       return redirect()->route('radiologictechnologist.releasings.index')->with('success', 'Result file uploaded successfully.');
   }
   ...
   public function releasingsSendEmail($id)
{
   try {
       ...
       if (!$releasing->transaction->patient->email_address) {
           ...
           $viewLink = route('radiologictechnologist.releasings.view', $releasing->id);
...
private function getErrorMessage(\Exception $e): string
{
   ...
   public function releasingsRelease(Request $request, $id)
   {
    ...
    public function transactionsIndex()
    {
        ...
        return view('radiologictechnologist.transactions.index', compact('transactions'));
    }
    ...
    public function transactionsCreate()
    {
        ...
        return view('radiologictechnologist.transactions.create', compact('patients', 'categories'));
    }
    ...
    public function transactionsStore(Request $request)
    {
        ...
        return redirect()->route('radiologictechnologist.transactions.index')->with('success', 'Transaction created successfully.');
    }

    public function transactionsShow(Transaction $transaction)
    {
        $transaction->load(['consultation', 'patient', 'services', 'queue']);
        return view('radiologictechnologist.transactions.show', compact('transaction'));
    }
    ...
    public function transactionsEdit(Transaction $transaction)
    {
        $categories = Category::all();
        $patients = Patient::all();
        return view('radiologictechnologist.transactions.edit', compact('transaction', 'categories', 'patients'));
    }
    ...
    public function transactionsUpdate(Request $request, Transaction $transaction)
    {
        ...
        return redirect()->route('radiologictechnologist.transactions.index')->with('success', 'Transaction updated successfully.');
    }

    public function transactionsDestroy(Transaction $transaction)
    {
        $transaction->delete();
        return redirect()->route('radiologictechnologist.transactions.index')->with('success', 'Transaction deleted successfully.');
    }
    ...
    public function transactionsMarkPaid(Transaction $transaction)
    {
        ...
        $transaction->save();
        return redirect()->route('radiologictechnologist.transactions.index')->with('success', 'Transaction marked as paid.');
    }
...
public function consultationsIndex()
{
    ...
    return view('radiologictechnologist.consultations.index', compact('consultations'));
}
...
public function consultationsCreate()
{
    ...
    return view('radiologictechnologist.consultations.create', compact('patients'));
}
...
public function consultationsStore(Request $request)
{
    ...
    return redirect()->route('radiologictechnologist.consultations.index')
...
public function consultationsShow($id)
{
    ...
    return view('radiologictechnologist.consultations.show', compact('consultation'));
}
...
public function consultationsEdit($id)
{
    ...
    return view('radiologictechnologist.consultations.edit', compact('consultation', 'patients'));
}
...
public function consultationsDestroy($id)
{
    ...
    return redirect()->route('radiologictechnologist.consultations.index')->with('success', 'Consultation deleted successfully.');
}
public function queuesDisplay()
{
    $queues = Queue::all(); // Adjust this query as needed
    return view('radiologictechnologist.queues.queue_display', compact('queues'));
}
...
public function consultationsForward($id)
{
    ...
    {
        return view('radiologictechnologist.queues.show_from_queue', compact('transaction'));
    }
}
