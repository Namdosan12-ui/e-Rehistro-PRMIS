...
use App\Mail\Admin\MedicalResultsMail;
...
public function usersDestroy(User $user)
{
    ...
    public function laboratoryServicesIndex(Request $request)
    {
        ...
        return view('admin.laboratory_services.index', compact('services'));
    }

    public function laboratoryServicesCreate()
    {
        $categories = Category::all();
        return view('admin.laboratory_services.create', compact('categories'));
    }
    ...
    public function laboratoryServicesStore(Request $request)
    {
        ...
        return redirect()->route('admin.laboratory_services.index')
    ...
    public function laboratoryServicesShow($id)
    {
        ...
        return view('admin.laboratory_services.show', compact('laboratoryService'));
    }
    ...
    public function laboratoryServicesEdit( $id)
    {
        ...
        return view('admin.laboratory_services.edit', compact('laboratoryService', 'categories'));
    }
    ...
    public function patientsCreate()
    {
        ...
        return view('admin.patients.create', compact('vaccineTypes', 'boosterTypes', 'civilStatusOptions', 'patientTypes'));
    }
    ...
    public function patientsShow(Patient $patient)
    {
        ...
        return view('admin.patients.show', compact('patient', 'civilStatusOptions'));
    }
    ...
    $patientTypes = PatientType::all();
        return view('admin.patients.edit', compact('patient', 'vaccineTypes', 'boosterTypes', 'civilStatusOptions', 'patientTypes'));
    }
    ...
    public function patientsDestroy(Patient $patient)
    {
        ...
        $patient->delete();
        return redirect()->route('admin.patients.index')->with('success', 'Patient has been deleted successfully.');
    }
    ...
    public function showPatientTransactions(Patient $patient)
    {
        ...
        return view('admin.patients.transactions', compact('patient', 'transactions'));
    }
...
public function queuesRelease(Queue $queue)
{
   ...
   public function releasingsUpload(Request $request, $id)
   {
       ...
       return redirect()->route('admin.releasings.index')->with('success', 'Result file uploaded successfully.');
   }
   ...
   public function releasingsSendEmail($id)
{
   try {
       ...
       if (!$releasing->transaction->patient->email_address) {
           ...
           $viewLink = route('admin.releasings.view', $releasing->id);
...
private function getErrorMessage(\Exception $e): string
{
   ...
   public function releasingsRelease(Request $request, $id)
   {
    ...
    public function transactionsCreate()
    {
        ...
        return view('admin.transactions.create', compact('patients', 'categories'));
    }
    ...
    public function transactionsEdit(Transaction $transaction)
    {
        $categories = Category::all();
        $patients = Patient::all();
        return view('admin.transactions.edit', compact('transaction', 'categories', 'patients'));
    }
    ...
    public function transactionsMarkPaid(Transaction $transaction)
    {
        ...
        $transaction->save();
        return redirect()->route('admin.transactions.index')->with('success', 'Transaction marked as paid, Please Proceed to Queuing.');
    }
...
public function consultationsCreate()
{
    ...
    return view('admin.consultations.create', compact('patients'));
}
...
public function consultationsEdit($id)
{
    ...
    return view('admin.consultations.edit', compact('consultation', 'patients'));
}
...
public function queuesDisplay()
{
    ...
    return view('admin.queues.queue_display', compact('queues'));
}
...
public function consultationsForward($id)
{
    ...
    {
        return view('admin.queues.show_from_queue', compact('transaction'));
    }
}
